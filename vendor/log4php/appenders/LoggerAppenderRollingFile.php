...
class LoggerAppenderRollingFile extends LoggerAppenderFile {
	 ...
	 * will be no backup files and the logs file will be truncated when it
	 ...
	 * Moreover, File is renamed File.1 and closed. A new File is created to receive further logs output.
	 * 
