...
/**
 * Log events to a system logs using the PHP syslog() function.
 *
 ...
 *     be determined by the message's logs level.
 ...
 * - PERROR - print logs message also to standard error
...
class LoggerAppenderSyslog extends LoggerAppender {
	...
	*/
	 ...
	 * can cause the Apache httpd server to logs to whatever ident/facility
	 * was used in openlog().
	 *
