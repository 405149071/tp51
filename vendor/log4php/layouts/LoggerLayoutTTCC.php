...
class LoggerLayoutTTCC extends LoggerLayout {
	 ...
	 * current thread is part of logs output or not. This is true by default.
	 */
	 ...
	 * name is part of logs output or not. This is true by default.
	 */
	...
	/**
	 * The <b>ContextPrinting</b> option specifies logs output will include
