...
class Lunar
{
    ...
    public function convertSolarToLunar($year,$month,$date)
    {
        ...
        $arr = $this->getLunarByBetween($year,$this->getDaysBetweenSolar($year,$month,$date,$yearData[1],$yearData[2]));
        $arr[] = $this->getJieQi($year,$month,$date);
        $arr[] = $this->getFestival($year .'-'. $month.'-'.$date,$arr,1);
        //var_dump($arr);
        return $arr;
    ...
    public function getFestival($today, $nl_info = false,$config = 1)
    {
        if($config == 1)
        {
            $arr_lunar=array('01-01'=>'春节','01-15'=>'元宵节','02-02'=>'龙头节','05-05'=>'端午节','07-07'=>'七夕节','07-15'=>'中元节','08-15'=>'中秋节','09-09'=>'重阳节','10-01'=>'寒衣节','10-15'=>'下元节','12-08'=>'腊八节','12-23'=>'小年');
            $arr_solar=array('01-01'=>'元旦','02-14'=>'情人节','03-03'=>'爱耳日','03-08'=>'妇女节','03-12'=>'植树节','03-15'=>'消费者权益日',
                '04-01'=>'愚人节','04-07'=>'世界卫生日','04-22'=>'世界地球日','05-01'=>'劳动节','05-04'=>'青年节','05-12'=>'护士节','05-17'=>'世界电信日','05-18'=>'世界博物馆日','05-31'=>'世界无烟日',
                '06-01'=>'儿童节','06-05'=>'世界环境日','06-23'=>'奥林匹克日','06-26'=>'国际禁毒日',
                '07-01'=>'建党节','08-01'=>'建军节','09-03'=>'抗战胜利日','09-10'=>'教师节',
                '10-01'=>'国庆节','10-16'=>'世界粮食日','10-20'=>'世界骨质疏松日', '10-31'=>'万圣节',
                '11-11'=>'光棍节','11-17'=>'世界大学生日',
                '12-01'=>'世界艾滋病日','12-13'=>'国家公祭日','12-24'=>'平安夜','12-25'=>'圣诞节');
        ...
        //节日 全国中小学生安全教育日 每年3月份最后一周的星期一
        if($m==3&&($d>24)&&($d<32)&&($glweek==1))array_push($festivals,"全国中小学生安全教育日");
        //每年5月的第一个周二  世界防治哮喘日
        if($m==5&&($d>0)&&($d<8)&&($glweek==2))array_push($festivals, "世界防治哮喘日");
        // 感恩节每年11月第四个星期四定为“感恩节
        if($m==11&&($d>21)&&($d<29)&&($glweek==4))array_push($festivals, "感恩节");
